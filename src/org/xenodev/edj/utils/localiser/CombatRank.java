package org.xenodev.edj.utils.localiser;

public class CombatRank {
	
	private static String[] localisedNames = {"Harmless", "Mostly Harmless", "Novice", "Competent", "Expert", "Master",	"Dangerous", "Deadly", "Elite"};
